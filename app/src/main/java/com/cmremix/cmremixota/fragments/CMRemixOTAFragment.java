...
package com.cmremix.cmremixota.fragments;
...
import com.cmremix.cmremixota.tasks.CheckUpdateTask;
import com.cmremix.cmremixota.utils.OTAUtils;
import com.cmremix.cmremixota.xml.OTALink;

import java.util.List;

public class CMRemixOTAFragment extends PreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.cmremixota);
